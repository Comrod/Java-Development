...
public class Calculator
{
	...
	public static void main(String[] args)
	{
		...
		System.out.print("Do you want to add, subtract, multiply, divide, or average ");
		...
		else if(operatorinput.equals("average") || operatorinput.equals("Agerage"))
		{
			answer = (int1 + int2) / 2;
			System.out.println("You chose averaging. Your answer is: " + answer);
		}
	}
